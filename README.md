# Web Calculator Instruction Set

## AI-Assisted Artifacts

- [HTML and CSS instructions](.github/instructions/html-css.instructions.md) - semantic markup and responsive styling guidance
- [TypeScript instructions](.github/instructions/typescript.instructions.md) - strict typing and safe calculator logic guidance
- [Vue instructions](.github/instructions/vue.instructions.md) - component and state guidance for the UI
- [Vitest instructions](.github/instructions/vitest.instructions.md) - unit test guidance for calculator behavior
- [Playwright instructions](.github/instructions/playwright.instructions.md) - end-to-end browser test guidance
- [GitHub Pages instructions](.github/instructions/github-pages.instructions.md) - static hosting and deployment guidance
- [Stakeholder showcase instructions](.github/instructions/stakeholder-showcase.instructions.md) - guidance for stakeholder-facing feature demos and decision gates
...
- [Conversation log](ai-logs/2026/05/22/web-calculator-tech-instructions-20260522/conversation.md)
- [Session summary](ai-logs/2026/05/22/web-calculator-tech-instructions-20260522/summary.md)
- [Vertical slice conversation log](ai-logs/2026/05/22/web-calculator-vertical-slices-20260522/conversation.md)
- [Vertical slice session summary](ai-logs/2026/05/22/web-calculator-vertical-slices-20260522/summary.md)
- [Implementation plan conversation log](ai-logs/2026/05/22/5b9a0fcd-33ad-4303-b549-a5e01d638762/conversation.md)
- [Implementation plan session summary](ai-logs/2026/05/22/5b9a0fcd-33ad-4303-b549-a5e01d638762/summary.md)
- [Stakeholder showcase instruction conversation log](ai-logs/2026/05/22/stakeholder-showcase-instructions-20260522/conversation.md)
